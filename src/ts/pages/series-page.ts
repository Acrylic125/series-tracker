...
const seriesCardsFragment = document.createDocumentFragment();

const SERIES_CARDS_CLASS = 'series-cards';
...
seriesCardsFragment.appendChild(testElement);

(function updateContent() {
    document.querySelectorAll(`.${SERIES_CARDS_CLASS}`).forEach((seriesCards) => {
        seriesCards.innerHTML = '';
        seriesCards.appendChild(seriesCardsFragment);
    });
})();
